...
public:
	...
	void glTranslate(glm::vec3 vec)
	{

		glm::mat4 Trans = glm::translate(glm::mat4(1.0f), vec);
		modelstack.top() = modelstack.top() * Trans;
	}
	...
	void glRotate(float degree, glm::vec3 vec)
	{
		glm::mat4 rot = glm::rotate(glm::mat4(1.0f), glm::radians(degree), vec);
		modelstack.top() = modelstack.top() * rot;
	}
	...
	void glScale(glm::vec3 vec)
	{
		glm::mat4 scale = glm::scale(glm::mat4(1.0f), vec);
		modelstack.top() = modelstack.top() * scale;
	}
